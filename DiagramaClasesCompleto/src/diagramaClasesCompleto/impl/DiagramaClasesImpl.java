...
public class DiagramaClasesImpl extends MinimalEObjectImpl.Container implements DiagramaClases {
	...
	public EList<ConfiguracionDB> getConfiguraciondb() {
		if (configuraciondb == null) {
			configuraciondb = new EObjectContainmentEList<ConfiguracionDB>(ConfiguracionDB.class, this, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDB);
		}
	...
	public EList<ConfiguracionDocker> getConfiguraciondocker() {
		if (configuraciondocker == null) {
			configuraciondocker = new EObjectContainmentEList<ConfiguracionDocker>(ConfiguracionDocker.class, this, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONDOCKER);
		}
	...
	public EList<ConfiguracionLenguaje> getConfiguracionlenguaje() {
		if (configuracionlenguaje == null) {
			configuracionlenguaje = new EObjectContainmentEList<ConfiguracionLenguaje>(ConfiguracionLenguaje.class, this, DiagramaClasesCompletoPackage.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE);
		}
