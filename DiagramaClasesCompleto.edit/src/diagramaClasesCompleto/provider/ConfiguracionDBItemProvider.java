 ...
 * @generated
 */
public class ConfiguracionDBItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_dbNombre_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__DB_NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addDbUsuarioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDB_dbUsuario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_dbUsuario_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__DB_USUARIO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_dbPuerto_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__DB_PUERTO,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_ip_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__IP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDbContrasenaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDB_dbContrasena_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_dbContrasena_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__DB_CONTRASENA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addServerPuertoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDB_serverPuerto_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_serverPuerto_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__SERVER_PUERTO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addTipoProveedorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDB_tipoProveedor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDB_tipoProveedor_feature", "_UI_ConfiguracionDB_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DB__TIPO_PROVEEDOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConfiguracionDB_type") :
