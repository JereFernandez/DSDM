		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaClasesCompletoPackage.Literals.ATRIBUTO__TIPO,
				 true,
				 false,
				 false,
	...
	protected void addEsAuditablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_esAuditable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_esAuditable_feature", "_UI_Atributo_type"),
				 DiagramaClasesCompletoPackage.Literals.ATRIBUTO__ES_AUDITABLE,
				 true,
				 false,
				 false,
	...
	protected void addPseudonimoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_pseudonimo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_pseudonimo_feature", "_UI_Atributo_type"),
				 DiagramaClasesCompletoPackage.Literals.ATRIBUTO__PSEUDONIMO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
