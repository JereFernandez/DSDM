		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndPoint_tipoVerdo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_tipoVerdo_feature", "_UI_EndPoint_type"),
				 DiagramaClasesCompletoPackage.Literals.END_POINT__TIPO_VERDO,
				 true,
				 false,
				 false,
	...
	protected void addTipoTransferenciaEntradaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndPoint_tipoTransferenciaEntrada_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_tipoTransferenciaEntrada_feature", "_UI_EndPoint_type"),
				 DiagramaClasesCompletoPackage.Literals.END_POINT__TIPO_TRANSFERENCIA_ENTRADA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTipoTransferenciaSalidaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndPoint_tipoTransferenciaSalida_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_tipoTransferenciaSalida_feature", "_UI_EndPoint_type"),
				 DiagramaClasesCompletoPackage.Literals.END_POINT__TIPO_TRANSFERENCIA_SALIDA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EndPoint_nombrePublicado_feature", "_UI_EndPoint_type"),
				 DiagramaClasesCompletoPackage.Literals.END_POINT__NOMBRE_PUBLICADO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
