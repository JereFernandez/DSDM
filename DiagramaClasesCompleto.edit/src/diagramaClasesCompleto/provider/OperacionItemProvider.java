		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operacion_tipoRetorno_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operacion_tipoRetorno_feature", "_UI_Operacion_type"),
				 DiagramaClasesCompletoPackage.Literals.OPERACION__TIPO_RETORNO,
				 true,
				 false,
				 false,
	...
	protected void addEsAbstractaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operacion_esAbstracta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operacion_esAbstracta_feature", "_UI_Operacion_type"),
				 DiagramaClasesCompletoPackage.Literals.OPERACION__ES_ABSTRACTA,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.OPERACION__PARAMETROS_CONTENIDOS,
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.OPERACION__ENDPOINT,
