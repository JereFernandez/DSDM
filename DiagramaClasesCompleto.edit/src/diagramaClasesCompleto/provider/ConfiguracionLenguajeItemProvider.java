 ...
 * @generated
 */
public class ConfiguracionLenguajeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionLenguaje_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionLenguaje_version_feature", "_UI_ConfiguracionLenguaje_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_LENGUAJE__VERSION,
				 true,
				 false,
				 false,
	...
	protected void addLenguajePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionLenguaje_lenguaje_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionLenguaje_lenguaje_feature", "_UI_ConfiguracionLenguaje_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_LENGUAJE__LENGUAJE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConfiguracionLenguaje_type") :
