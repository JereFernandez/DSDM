 ...
 * @generated
 */
public class RetornableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Retornable_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Retornable_nombre_feature", "_UI_Retornable_type"),
				 DiagramaClasesCompletoPackage.Literals.RETORNABLE__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addVisibilidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Retornable_visibilidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Retornable_visibilidad_feature", "_UI_Retornable_type"),
				 DiagramaClasesCompletoPackage.Literals.RETORNABLE__VISIBILIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEsFinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Retornable_esFinal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Retornable_esFinal_feature", "_UI_Retornable_type"),
				 DiagramaClasesCompletoPackage.Literals.RETORNABLE__ES_FINAL,
				 true,
				 false,
				 false,
	...
	protected void addEsStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Retornable_esStatic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Retornable_esStatic_feature", "_UI_Retornable_type"),
				 DiagramaClasesCompletoPackage.Literals.RETORNABLE__ES_STATIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
