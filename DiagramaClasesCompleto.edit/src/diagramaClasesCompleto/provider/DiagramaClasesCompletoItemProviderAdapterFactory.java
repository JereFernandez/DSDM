 ...
 * @generated
 */
public class DiagramaClasesCompletoItemProviderAdapterFactory extends DiagramaClasesCompletoAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	...
	public void dispose() {
		...
		if (realizacionItemProvider != null) realizacionItemProvider.dispose();
		if (artefactoItemProvider != null) artefactoItemProvider.dispose();
		if (endPointItemProvider != null) endPointItemProvider.dispose();
		if (configuracionDBItemProvider != null) configuracionDBItemProvider.dispose();
		if (configuracionDockerItemProvider != null) configuracionDockerItemProvider.dispose();
		if (configuracionLenguajeItemProvider != null) configuracionLenguajeItemProvider.dispose();
	}
