	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.DIAGRAMA_CLASES__PACKAGES_CONTENIDOS,
				 DiagramaClasesCompletoFactory.eINSTANCE.createPackage()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.DIAGRAMA_CLASES__ARTEFACTO_CONTENIDO,
				 DiagramaClasesCompletoFactory.eINSTANCE.createArtefacto()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.DIAGRAMA_CLASES__CONFIGURACIONDB,
				 DiagramaClasesCompletoFactory.eINSTANCE.createConfiguracionDB()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.DIAGRAMA_CLASES__CONFIGURACIONDOCKER,
				 DiagramaClasesCompletoFactory.eINSTANCE.createConfiguracionDocker()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.DIAGRAMA_CLASES__CONFIGURACIONLENGUAJE,
