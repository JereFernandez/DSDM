		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaClasesCompletoPackage.Literals.RELACION__DESTINO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaClasesCompletoPackage.Literals.RELACION__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addTipoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relacion_tipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relacion_tipo_feature", "_UI_Relacion_type"),
				 DiagramaClasesCompletoPackage.Literals.RELACION__TIPO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMultiplicidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relacion_multiplicidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relacion_multiplicidad_feature", "_UI_Relacion_type"),
				 DiagramaClasesCompletoPackage.Literals.RELACION__MULTIPLICIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DiagramaClasesCompletoPackage.Literals.RELACION__ORIGEN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEsFinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relacion_esFinal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relacion_esFinal_feature", "_UI_Relacion_type"),
				 DiagramaClasesCompletoPackage.Literals.RELACION__ES_FINAL,
				 true,
				 false,
				 false,
	...
	protected void addEsStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relacion_esStatic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relacion_esStatic_feature", "_UI_Relacion_type"),
				 DiagramaClasesCompletoPackage.Literals.RELACION__ES_STATIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addVisibilidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relacion_visibilidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relacion_visibilidad_feature", "_UI_Relacion_type"),
				 DiagramaClasesCompletoPackage.Literals.RELACION__VISIBILIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.RELACION__CLASES_ASOCIATIVAS_CONTENIDAS,
