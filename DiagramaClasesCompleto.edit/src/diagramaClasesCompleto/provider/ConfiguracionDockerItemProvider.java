 ...
 * @generated
 */
public class ConfiguracionDockerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDocker_nombreContenedor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDocker_nombreContenedor_feature", "_UI_ConfiguracionDocker_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DOCKER__NOMBRE_CONTENEDOR,
				 true,
				 false,
				 false,
	...
	protected void addPuertoInteriorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDocker_puertoInterior_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDocker_puertoInterior_feature", "_UI_ConfiguracionDocker_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DOCKER__PUERTO_INTERIOR,
				 true,
				 false,
				 false,
	...
	protected void addTipoReinicioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDocker_tipoReinicio_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDocker_tipoReinicio_feature", "_UI_ConfiguracionDocker_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DOCKER__TIPO_REINICIO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNombreImagenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfiguracionDocker_nombreImagen_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfiguracionDocker_nombreImagen_feature", "_UI_ConfiguracionDocker_type"),
				 DiagramaClasesCompletoPackage.Literals.CONFIGURACION_DOCKER__NOMBRE_IMAGEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConfiguracionDocker_type") :
