		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_nombre_feature", "_UI_Artefacto_type"),
				 DiagramaClasesCompletoPackage.Literals.ARTEFACTO__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addGrupoIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_grupoId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_grupoId_feature", "_UI_Artefacto_type"),
				 DiagramaClasesCompletoPackage.Literals.ARTEFACTO__GRUPO_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addArtefactotIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_artefactotId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_artefactotId_feature", "_UI_Artefacto_type"),
				 DiagramaClasesCompletoPackage.Literals.ARTEFACTO__ARTEFACTOT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_descripcion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_descripcion_feature", "_UI_Artefacto_type"),
				 DiagramaClasesCompletoPackage.Literals.ARTEFACTO__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_version_feature", "_UI_Artefacto_type"),
				 DiagramaClasesCompletoPackage.Literals.ARTEFACTO__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
