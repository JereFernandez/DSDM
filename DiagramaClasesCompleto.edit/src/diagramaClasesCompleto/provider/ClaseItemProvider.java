		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clase_esAbstracta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clase_esAbstracta_feature", "_UI_Clase_type"),
				 DiagramaClasesCompletoPackage.Literals.CLASE__ES_ABSTRACTA,
				 true,
				 false,
				 false,
	...
	protected void addEsAsociativaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clase_esAsociativa_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clase_esAsociativa_feature", "_UI_Clase_type"),
				 DiagramaClasesCompletoPackage.Literals.CLASE__ES_ASOCIATIVA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addEsAuditablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clase_esAuditable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clase_esAuditable_feature", "_UI_Clase_type"),
				 DiagramaClasesCompletoPackage.Literals.CLASE__ES_AUDITABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addTieneABMPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clase_tieneABM_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clase_tieneABM_feature", "_UI_Clase_type"),
				 DiagramaClasesCompletoPackage.Literals.CLASE__TIENE_ABM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.CLASE__RELACIONES_CONTENIDAS,
				 DiagramaClasesCompletoFactory.eINSTANCE.createRelacion()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramaClasesCompletoPackage.Literals.CLASE__REALIZACIONES_CONTENIDAS,
